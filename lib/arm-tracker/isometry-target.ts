...
export function getIsometryTargetSeconds(plannedReps: number | null | undefined): number {
  if (plannedReps === null || plannedReps === undefined || !Number.isFinite(plannedReps) || plannedReps <= 0) {
